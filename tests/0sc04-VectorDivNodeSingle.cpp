...
float testVectorDivNode(MemoryDimensions input1Dim, InputDataBuffer& input1, MemoryDimensions input2Dim, InputDataBuffer& input2, ConstDataBuffer& expected)
{
    ...
    DataBuffer result(compilationMemoryMap.GetNodeMemoryDimensions(&testDivNode).size());
...
int main(int argc, const char * const argv[])
{
    ...
    error = testVectorDivNode(MemoryDimensions({m, n}), input1, MemoryDimensions({m, n}), input2, expected);
    ...
    error = testVectorDivNode(MemoryDimensions({m, n}), input1, MemoryDimensions({1, n}), input2, expected);
    ...
    error = testVectorDivNode(MemoryDimensions({m, n}), input1, MemoryDimensions({m, 1}), input2, expected);
