...
public:
    VectorDivNodeGPUKernel(OpenCLCompiler& compiler, cl_command_queue queue, cl_mem memA, cl_mem memB, cl_mem memRes, MemoryDimensions dimA, MemoryDimensions dimB);
